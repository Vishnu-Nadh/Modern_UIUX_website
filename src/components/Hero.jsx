      ...
      >
        ...
        >
          <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
            ...
            <p className={`${styles.paragraph} ml-2 flex flex-wrap gap-2`}>
          ...
          <h1 className="font-poppins font-semibold text-white ss:text-[68px] text-[52px] ss:leading-[100px] w-fulll leading-[75px]">
            Payment Method
          </h1>
          <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
            Our team uses a methodology to identify the credit card most likely
